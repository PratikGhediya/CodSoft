...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value = ''
        tk.Entry(master, width=17, bg='#ccddff', font=('Arial', 28), textvariable=self.equation).place(x=0, y=0)
        ...
        tk.Button(width=11, height=4, text='6', relief='flat', bg='white', command=lambda: self.show(6)).place(x=180, y=200)
        tk.Button(width=11, height=4, text='7', relief='flat', bg='white', command=lambda: self.show(7)).place(x=0, y=275)
        tk.Button(width=11, height=4, text='8', relief='flat', bg='white', command=lambda: self.show(8)).place(x=90, y=275)
        tk.Button(width=11, height=4, text='9', relief='flat', bg='white', command=lambda: self.show(9)).place(x=180, y=275)
        ...
        tk.Button(width=11, height=4, text='*', relief='flat', bg='white', command=lambda: self.show('*')).place(x=270, y=125)
